...
public class DeploymentConfig {
	...
	public DeploymentPath deploymentPath() {
		...
		return new DeploymentPath(createDir(deployLocation, DeploymentConstant.MODULE_DEPLOY_FOLDER),
				createDir(deployLocation, DeploymentConstant.THEME_DEPLOY_FOLDER),
				...
				createDir(deployLocation, DeploymentConstant.SITE_DEPLOY_FOLDER));
	}
